...
import { ComputedRef, computed, onBeforeUnmount, onUnmounted, provide, ref, watch } from 'vue';
import {
...
import { AnnotationMark, HighlightMark } from '../services/marks';
...
const test = `<p><span data-annotation-type="emphasised" data-annotation-uuid="9f86d5bb-d7c2-4507-9088-30914a26cbca" data-annotation-subtype="rubricated" class="annotation">Im letzten Teil der Trilogie </span>erfährt man zu<span data-annotation-type="correction" data-annotation-uuid="d3f1a990-c44b-44e9-a473-1a71fbf3cc1b" data-annotation-subtype="inPlace" class="annotation">nächst in e<span data-annotation-type="entity" data-annotation-uuid="bbe79346-f78e-4beb-873a-34a2f1ccc474" data-annotation-subtype="imagery" class="annotation">iner R</span></span><span data-annotation-type="entity" data-annotation-uuid="bbe79346-f78e-4beb-873a-34a2f1ccc474" data-annotation-subtype="imagery" class="annotation">ückblend</span>e, wie aus Sméagol die Kreatur Gollum geworden ist: Zwei hobbitähnliche Gestalten sind in einem Boot zu<span data-annotation-type="transposition" data-annotation-uuid="b23b960d-0ce3-4e69-9236-8aced02cc769" class="annotation"> sehen. Wie </span>sich herausstellt, handelt es sich dabei um Dé<span data-annotation-type="expansion" data-annotation-uuid="22ae746e-1a19-4df7-b9cf-0dbe9b3d8278" class="annotation">agol und Sméagol, di</span><span data-annotation-type="nonLinear" data-annotation-uuid="adbb1f59-a1b6-4347-b0c5-60f541fc1418" data-annotation-subtype="aboveLine" class="annotation"><span data-annotation-type="expansion" data-annotation-uuid="22ae746e-1a19-4df7-b9cf-0dbe9b3d8278" class="annotation">e zu</span>m sogenannten Flussvolk<span data-annotation-type="head" data-annotation-uuid="2f28b28f-a0c7-467b-89a0-040f3a904c20" class="annotation"> gehör</span>en. Déagol wird von einem großen Fisch in den Fluss gezogen. Unter Wasser entdeckt er </span>etwas Glitzerndes und greift danach. An Land stellt er fest, dass es sich hierbei um einen golden<span data-annotation-type="expansion" data-annotation-uuid="11c85dc2-ad9d-4131-88ba-37d0bd85c9e2" class="annotation">en Ring </span>handelt. Sméagol wird darauf aufmerksam und will diesen Ring unbedingt haben. Als <span data-annotation-type="sic" data-annotation-uuid="47805bdb-5e6a-4156-90d8-63143b9473fd" data-annotation-subtype="corr" class="annotation">Déagol sich weigert, <span data-annotation-type="expansion" data-annotation-uuid="38b8e42c-7f5b-418f-9d6f-457555d9d48b" class="annotation">entbrennt </span>ein Kampf zwischen den beiden, in dessen Verlauf Sméagol Déagol erwürgt. Er zieht sich daraufhin in</span><span data-annotation-type="commentary" data-annotation-uuid="a9f22c2b-2d5b-40fe-ac28-2ac90a4f713d" class="annotation"><span data-annotation-type="sic" data-annotation-uuid="47805bdb-5e6a-4156-90d8-63143b9473fd" data-annotation-subtype="corr" class="annotation"> eine Hö<span data-annotation-type="entity" data-annotation-uuid="2e36074d-16a0-4983-8fc8-087509213218" data-annotation-subtype="concept" class="annotation">hle zurü</span></span></span><span data-annotation-type="sic" data-annotation-uuid="47805bdb-5e6a-4156-90d8-63143b9473fd" data-annotation-subtype="corr" class="annotation"><span data-annotation-type="entity" data-annotation-uuid="2e36074d-16a0-4983-8fc8-087509213218" data-annotation-subtype="concept" class="annotation">ck, </span>in der er sich unter dem Einfluss des Ringes im Laufe der Jahrhunderte zu G</span>ollum wandelt, was in einer Art „Zeitraffer“ dargestellt wird.In Rohan erholt man sich von den Angriffen der Uruk-hai-Ar<span data-annotation-type="expansion" data-annotation-uuid="0a383792-d6e8-4dc1-a77a-439758681668" class="annotation">me</span>e. König Théoden fragt sich, ob er das Reich von Gondor unterstützen soll, das seinem Reich nicht geholfen hat. Aragorn macht ihm<span data-annotation-type="expansion" data-annotation-uuid="0aaae9ae-0f58-4d08-8ea5-23897d358a14" class="annotation"> klar, </span>dass es keine andere Möglichkeit gi<span data-annotation-type="expansion" data-annotation-uuid="35b21139-49e8-4abe-92f2-95a1721a7455" class="annotation">bt, den dr</span>ohenden neue<span data-annotation-type="expansion" data-annotation-uuid="596ce2f2-d718-4638-986e-e73116d358e2" class="annotation">n Angriff</span>en standzuhalten. Pippin blickt unerlaubterweise in den in Gandalfs Besitz befindlichen Palantir, der eine verräterisc<span data-annotation-type="expansion" data-annotation-uuid="ccd1d995-d1d2-488b-a802-9ec54e7ad933" class="annotation">he Ver</span>bindung na<span data-annotation-type="expansion" data-annotation-uuid="ed0f7e8e-066e-4d76-ad32-72a5a510ec7f" class="annotation">ch</span> Mordor herstellt. Durch Pippins Erzählung <span data-annotation-type="expansion" data-annotation-uuid="5de8005a-198e-4583-82e4-106416e130bf" class="annotation">erkennt </span>Gandalf Saurons <span data-annotation-type="expansion" data-annotation-uuid="58761920-01af-400d-acd6-157340986544" class="annotation">nächstes </span>Angriffsziel: die Hauptstadt von Gondor, Minas T<span data-annotation-type="expansion" data-annotation-uuid="f5f779af-d6a9-4fbc-96ff-58a49c3b411a" class="annotation">irith. </span>Die Maßnahmen der <span data-annotation-type="expansion" data-annotation-uuid="f512705d-341b-4a7d-9b42-84cd6d4273fc" class="annotation">Ringgemeinschaft </span>richten <span data-annotation-type="expansion" data-annotation-uuid="d41f800a-b4ec-458f-8d2c-d553078dc360" class="annotation">sich </span>damit auf die Verteidigung dieser Stadt. Gandalf reitet mit Pippin nach Minas Tirith zu Denethor, dem Vater vo<span data-annotation-type="expansion" data-annotation-uuid="6ad261cf-a0d2-43c7-82f5-778c9f045037" class="annotation">n Boro</span>mir und Faramir und zugleich Truchsess von Gondor. Dort angekommen, erzählt Denethor ihnen, d<span data-annotation-type="expansion" data-annotation-uuid="c053af41-63b6-4df4-a946-1dad86f58bd3" class="annotation">ass </span>er vom Tode Boromirs weiß. Gandalf wollte Denethor den Tod seines Sohnes verheimlichen, da er <span data-annotation-type="expansion" data-annotation-uuid="fcbedb87-d132-484a-847e-aec16049bf5f" class="annotation">sich</span> darüber im Klaren war, dass <span data-annotation-type="entity" data-annotation-uuid="d531f9ec-45c9-4732-908d-c1f7cce40020" data-annotation-subtype="person" class="annotation">Den<span data-annotation-type="commentary" data-annotation-uuid="4f5dc914-6474-4e1c-8dda-52b7482d21c0" class="annotation">ethor </span></span><span data-annotation-type="commentary" data-annotation-uuid="4f5dc914-6474-4e1c-8dda-52b7482d21c0" class="annotation">durch </span><span data-annotation-type="entity" data-annotation-uuid="128bab78-12d3-43d8-a386-b83e8d050458" data-annotation-subtype="person" class="annotation"><span data-annotation-type="commentary" data-annotation-uuid="4f5dc914-6474-4e1c-8dda-52b7482d21c0" class="annotation">Bo</span>romirs </span>Tod deprimiert würde. Denethor will Rohan nicht um Hilfe bitten, da er fürchtet, dann von Aragorn (dem rechtmäßigen Thronerb<span data-annotation-type="expansion" data-annotation-uuid="5ba7dbc5-09a4-431b-84c5-cc5699a77c82" class="annotation">en) seiner M</span>acht beraubt zu werden. Pippin stel<span data-annotation-type="entity" data-annotation-uuid="f1982a30-9bad-4c70-bda8-7766da378e23" data-annotation-subtype="concept" class="annotation">lt sich aus Schuldgefühlen gegenüber Boromir derweil in den Dienst Denethors. Das Heer Saurons macht sich von Minas Morgul</span> aus auf den Weg, um zuerst Osgiliath, die Grenzstadt von Gondor, anzugreifen. D<span data-annotation-type="nonLinear" data-annotation-uuid="aed1c8e8-5cbe-4b07-86be-5e87edd5204b" data-annotation-subtype="aboveLine" class="annotation">enethor scheint nicht mehr in der Lage, seinen Verpflichtungen als Truchsess nachzukommen. So greift Gandalf ins Geschehen ein, indem er von Pippin die Kette der Leuchtfeuer in Gang setzen lässt, die Kön<span data-annotation-type="head" data-annotation-uuid="aa0c4b2e-48b6-4cc7-88a6-48452830cf41" class="annotation">ig T</span>héod</span>en und <span data-annotation-type="unclear" data-annotation-uuid="f96fdfed-f4a4-4fa4-aee7-7f5fcc1c4a7a" class="annotation">seine Männer zur Hilfe rufen. Gandalf versucht verzweifelt, die mutlosen Kämpfer von Gondor zu motivieren. Zur selben Ze</span>it sammelt sich Saurons Armee in Mordor.Wäh<span data-annotation-type="repeated" data-annotation-uuid="754daba0-4261-4c7b-a533-6f69a81f5f2f" class="annotation">renddess<span data-annotation-type="entity" data-annotation-uuid="00c3d585-184e-4d49-a980-ffd70db7dc41" data-annotation-subtype="concept" class="annotation">en sammelt Th</span>éoden die Krieger von Rohan zusammen, um Gondor zur Hilfe zu kommen. Leider stellt sich schon bald heraus</span>, dass es weitaus weniger sind, als man gehofft hat, nämlich nur 6000. Einige Männer vereinzelter Provin<span data-annotation-type="gap" data-annotation-uuid="f388692a-5724-44af-9866-07b8f50f0e92" class="annotation">zen Rohans ware</span>n nicht gekomme<span data-annotation-type="sic" data-annotation-uuid="3ce62a28-ecdd-4d91-9567-878a2dfdaaac" data-annotation-subtype="corr" class="annotation">n. König Théod</span>en kann trotz dieser Lage seine Manne<span data-annotation-type="correction" data-annotation-uuid="d9dcef92-95a3-4635-a609-5a4d2a78e17c" data-annotation-subtype="inPlace" class="annotation">n vereinen u</span>nd reitet Gondor zur Hilfe. Unter den Kriegern befinden sich unerkannt auch Merry und Éowyn.Sam gerät derweil heftig mit Frodo aneinand<span data-annotation-type="gap" data-annotation-uuid="40107aaa-4a54-47ec-8ba6-99593337ff0b" class="annotation">er, weil er Gollum nicht traut. Sie müssen mit ansehen, wie Tausende von Saurons Kämpfern Minas Morgul verlassen und wie der Hexenkönig von Angmar, Führer der Nazgûl, in die Schlacht zieht. Fro</span>do <span data-annotation-type="head" data-annotation-uuid="e317ec6e-3821-49cb-bfd3-89e5a416ef8f" class="annotation">verlässt sich aber offenbar imm</span>er mehr auf Gollum, der zudem Sam durch eine Täuschung noch Nahrungsmitteldiebstahl unterschiebt, und lässt Sam zurück. Er hat allerdings nicht mit der Tücke Gollums gerechnet, der ihn direkt in die Höhlen der Riesenspinne Kankra lockt. Prompt wird Frodo von ihr entdeckt und attackiert. Die Spinne hüllt den bewusstlosen Frodo in einen Kokon aus Spinnfäden.Am Vorabend der Schlacht wird Aragorn in das Zelt von Théoden gebeten. Dort wartet Elrond auf ihn. Er erklärt, dass Arwen, seine einzige über alles geliebte Tochter, nicht in den Westen gereist ist und darum nun im Sterben liegt, jetzt, wo sich der Schatten Mordors ausbreitet. Er gibt Aragorn den Rat, für die bevorstehende Schlacht die Unterstützung der Untoten anzufordern, die jedoch nur dem König von Gondor folgen. Er überreicht Aragorn das Schwert Andúril, die Flamme des Westens, geschmiedet aus den Bruchstücken Narsils, das seiner Forderung gegenüber den Untoten Nachdruck verleihen soll. Aragorn macht sich gemeinsam mit Legolas und Gimli auf den Weg zum Pfad der Toten. Diese Verstoßenen wurden einst von Isildur als „Eidbrecher“ verflucht, weil sie ihn trotz eines Treueeides im Stich ließen, und müssen nun als Untote in den Bergen ihr Dasein fristen, bis der Eid erfüllt wird. Am Ende des Pfades, inmitten des Berges, stoßen die drei Gefährten auf das Heer der Untoten. Aragorn als rechtmäßiger Erbe Isildurs verlangt von ihnen, für ihn zu kämpfen und so ihren Eid einzulösen. Als Gegenleistung verspricht er, den Eid als erfüllt anzusehen und sie freizugeben.Denethor befiehlt Faramir, die vom Feind besetzte Stadt Osgiliath zurückzuerobern. Faramir ist jedoch mit seinen Männern der Übermacht hoffnungslos unterlegen. Als einziger Überlebender gelangt er schwer verletzt nach Minas Tirith zurück. Denethor erkennt in seiner Verzweiflung nicht, dass Faramir noch am Leben ist. Den Tod beider Söhne kann er nicht verschmerzen und beschließt, Faramir und sich selbst zu verbrennen. Pippin kann Gandalf rechtzeitig erreichen, und gemeinsam können sie Faramir vor dem Flammentod bewahren. Denethor jedoch stürzt sich brennend von der Festung in die Tiefe.In Gondor toben derweil heftige Kämpfe. Tausende von Orks, unterstützt von zahlreichen Trollen und Haradrim, rücken gegen die Stadt Minas Tirith vor. Die Krieger der Menschen scheinen diesem Ansturm trotz Gandalfs Bemühungen nur wenig entgegensetzen zu können. Auf den Feldern vor den Toren der Stadt kommt es zur Schlacht auf dem Pelennor. Als die Reiter von Rohan unter Führung von König Théoden auf den Feldern eintreffen, scheint sich das Blatt zunächst zum Guten zu wenden. Einen Rückschlag müssen sie einstecken, als die Haradrim (Südländer) mit ihren gigantischen Mûmakil (Olifanten) auf dem Schlachtfeld eintreffen. Und auch die Nazgûl auf ihren fliegenden Bestien unterstützen die Armeen Mordors.Sam ist Frodo und Gollum unterdessen heimlich gefolgt und trifft in den Höhlen ebenfalls auf Kankra. In einem erbitterten Kampf kann er die Riesenspinne in die Flucht schlagen, ist aber entsetzt über Frodos vermeintlichen Tod. Als Orks auftauchen, muss er sich zurückziehen und zusehen, wie sie den verschnürten Frodo entdecken. Durch die Gespräche der Orks erfährt er, dass Kankra ihr Opfer dieses Mal wieder nur betäubt hat. Als sie Frodo mitnehmen, folgt ihnen Sam nach Cirith Ungol.Auf den Schlachtfeldern greift der Hexenkönig derweil König Théoden an und bringt dessen Pferd zu Fall, welches Theodén unter sich begräbt. Éowyn kommt ihrem König zu Hilfe und schlägt dem Reittier des Nazgûls den Kopf ab. Éowyn stellt sich auch dem Nazgûl entgegen. Sie wird zwar verletzt, aber Merry kann ihr helfen, indem er dem Hexenkönig mit seinem Dolch in die Ferse sticht. Der Hexenkönig fühlt sich im Kampf gegen Éowyn unbesiegbar, da er nach einer Legende „durch keines Mannes Hand getötet werden kann“. Éowyn ist jedoch eine Frau. Sie tötet ihn, indem sie ihm ihr Schwert in das unsichtbare Gesicht stößt. Ihrem Onkel, König Théoden, kann sie nicht mehr helfen. Er stirbt noch auf dem Schlachtfeld.Am Hafen kommen unterdessen die Schiffe der Korsaren von Umbar (Verbündete des dunklen Herrschers) an, doch Aragorn, Legolas und Gimli haben diese mit Hilfe der Armee der Eidbrecher übernommen und überfluten das Schlachtfeld mit den Geistern. Die Eidbrecher können die Schlacht entscheiden und Minas Tirith retten. Aragorn kommt seinem Versprechen nach und sieht ihren Eid als erfüllt an.Die Orks unter der Führung von Gorbag und Shagrat, die Frodo bewachen sollen, geraten in Streit über dessen Habseligkeiten und bringen sich zum Großteil gegenseitig um. Frodo erwacht aus seiner Bewusstlosigkeit und muss voller Entsetzen feststellen, dass der Ring nicht mehr da ist. Sam dringt in den Turm ein und teilt dem überraschten Frodo mit, dass er den Ring an sich genommen habe, weil er ihn für tot gehalten habe. Die beiden Hobbits machen sich nun als Orks verkleidet auf den Weg durch Mordor. Unter größten Mühen erreichen sie schließlich den Schicksalsberg.Während Frodo und Sam durch Mordor marschieren, beschließt Aragorn, mit einem Ablenkungsmanöver die Aufmerksamkeit Saurons auf sich zu lenken, um dem Ringträger den Weg zu erleichtern. Mit den Armeen von Gondor und Rohan zieht er vor das Schwarze Tor. Er will, beflügelt von seinen Hoffnungen, Arwen wiederzusehen, Saurons Blick so lange auf sich ziehen, bis Frodo den Ring vernichtet hat.Da sich der Blick Saurons nun vollkommen auf die Schlacht konzentriert, ist es Frodo und Sam nun möglich, ihren Weg zum Schicksalsberg fortzusetzen. Als Frodo aber den Ring in die glühende Lava werfen will, um ihn zu vernichten, gewinnt der Ring endgültig Macht über ihn. Frodo weigert sich, ihn zu zerstören, und scheitert so an der Macht des Ringes. Allerdings lauert Gollum im Hintergrund, der den beiden Hobbits gefolgt ist und nun den Ring in seine Gewalt bringen will. Er greift Frodo an, worauf ein Kampf entbrennt, in dessen Verlauf Gollum Frodos Finger mitsamt dem Ring abbeißt. Dabei stürzt Gollum mit dem Ring in die glühende Lava und vollzieht so ungewollt die Vernichtung des Ringes.Der Schicksalsberg bricht aus und vernichtet Mordor. Saurons Armee, das Schwarze Tor und Saurons Festung Barad-dûr mitsamt dem Feuer-Auge werden von der Erde verschlungen. Die dunkle Macht ist besiegt. Sam und Frodo haben sich auf einen Felsblock inmitten der glühenden Lavamassen an den Hängen des Berges geflüchtet und sind nun hilflos und von jedem Ausweg abgeschnitten. Gandalf will unterdessen nicht an den Tod der Hobbits glauben und macht sich mit Gwaihir und zwei anderen Adlern auf die Suche nach ihnen. Er kann sie retten und in Sicherheit nach Gondor bringen.Aragorn tritt nun sein Erbe an und wird von Gandalf zum König Elessar von Gondor gekrönt. Arwen wird seine Frau. Die Hobbits kehren in das Auenland zurück und die Gemeinschaft löst sich auf. Samweis heiratet Rosie.Drei Jahre später erweisen die Elben dem stark gealterten Bilbo als ehemaligem Ringträger die Gunst, sie von den Grauen Anfurten aus zu den unsterblichen Landen westlich des Meeres zu begleiten. Bilbo nimmt dieses letzte Abenteuer an. Gandalf und – zur Überraschung und zum Entsetzen von Merry, Sam und Pippin – auch Frodo verlassen gemeinsam mit Elrond, Galadriel und ihrem Mann Celeborn Mittelerde.</p>`;

watch(totalCharacters, () => {
  // editor.value.commands.setContent(totalCharacters.value.map(c => c.data.text).join(''));
});
const editor = useEditor({
  content: test,
  extensions: [StarterKit, AnnotationMark, HighlightMark],
  editorProps: {
    attributes: {
...
<template>
  ...
  <div v-else class="container flex h-screen">
    ...
    >
      ...
      <div spellcheck="false" ref="tiptapEditor" id="text" class="w-full" :editor="editor" />
